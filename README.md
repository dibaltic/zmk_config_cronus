This is the firmware for [cronus](https://github.com/dibaltic/cronus). It is based on the [bird layout](https://github.com/jcmkk3/bird-layout), but of course you can make it whatever you'd like. 
